...
private String usuario="sistemas";private String contraseña="123";
private String server="localhost";private String BaseDatos="SistemaVentas1";
...
public static ResultSet rs;public static Statement st;
private String msj="A ocurrido un error al conectarse  , Porfavor"
        + "\n verfique bién su clave y usuario"
        + "\n usted , las credenciales resultaron incorrectas podría ser por falta "
        + "\n del Driver, porfavor proceda a agregar el driver de la conexion"
...
//   JOptionPane.showMessageDialog(null,msj,"no conectado",
